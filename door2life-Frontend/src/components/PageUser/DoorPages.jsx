...
import WelcomeVideo from "./WelcomeVideo"; // Importamos el nuevo componente
...
const DoorPages = () => {
  ...
  const doorPages = [
    { name: "welcomeVideo" }, // Añadimos la nueva página
    { name: "register" },
    { name: "workGroup" },
    { name: "receiveGifts" },
    { name: "sendGifts" },
  ...
  const [selectedPage, setSelectedPage] = useState("welcomeVideo"); // Seleccionamos la página de bienvenida por defecto
    ...
    <>
      ...
      <div className="flex flex-col mt-1 h-max md:flex-row lg:mx-16 ">
        ...
        <div className="flex-1 p-5 h-max">
          {selectedPage === "welcomeVideo" && <WelcomeVideo />}
